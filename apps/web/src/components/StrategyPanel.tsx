      ...
      <div className="rounded-2xl border border-zinc-200 p-4">
        ...
        <div className="mt-4 space-y-3 text-sm text-zinc-700">
          {strategyResult ? (
            ...
            <p className="text-sm text-zinc-500">No strategy analysis yet. Click “Analyze” to price the configured legs.</p>
          )}
